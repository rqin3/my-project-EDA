...
Current_Public_Insurance_Distribution_Pie_Chart=create_pie_chart(clean_dta, "Current_Public_Insurance", "Current Public Insurance Distribution")
Current_Private_Insurance_Distribution_Pie_Chart=create_pie_chart(clean_dta, "Current_Public_Insurance", "Current Public Insurance Distribution")
Current_Medicaid_Distribution_Pie_Chart=create_pie_chart(clean_dta, "Current_Medicaid", "Current Medicaid Distribution")
```

#### When it comes to the categorical household income, due to the wide range of categories that could make the pie chart difficult to interpret, we decided to dichotomize the variable into two categories ("below $83,000", and "$83,000 and over"). We chose $83,000 as the threshold as it was the median, allowing us to ensure relatively equal sample sizes in both categories.
```{r}
...
clean_dta$Binary_Household_Income=factor(clean_dta$Binary_Household_Income,
                                        levels=c(1,2),
                                        labels=c("below $83,000","$83,000 and over")) 
...
```{r, echo=FALSE}
#Display the plots in grid layout

grid.arrange(Metro_Status_Distribution_Pie_Chart, Current_Health_Insurance_Distribution_Pie_Chart,Current_Public_Insurance_Distribution_Pie_Chart,Current_Private_Insurance_Distribution_Pie_Chart,Current_Medicaid_Distribution_Pie_Chart, Current_Binary_Household_Income_Distribution_Pie_Chart, ncol=2)
...
### U.S. Census Bureau. 2024. “Annual Social and Economic Supplements.” Census.gov, September 10, 2024. https://www.census.gov/data/datasets/time-series/demo/cps/cps-asec.html
